...
namespace jm726.lib.wrapper.logger {
    ...
    public class XmlLogReader {
        ...
        public void PlayRecording(XmlDocument events, bool stepping, bool timing, params Assembly[] assemblies) {
        ...
        public void MapInstance(Type TToMapTo, object instance, bool ignoreInheritance = true) {
            ...
            ObjectSerializer.RegisterAssembly(TToMapTo.Assembly);
            ObjectSerializer.RegisterAssembly(instance.GetType().Assembly);
