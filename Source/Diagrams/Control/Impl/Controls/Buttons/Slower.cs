...
namespace Diagrams.Control.impl.Buttons.ControlButtons {
    public class Slower : ControlButton {
        private int TimeInc {
            get {
                return _control.Wait / 4;
            }
        }
        ...
        public Slower(IButton button, IModule control, IPrim hostPrim)
            : base(button) {
        ...
        protected override void Touched(UUID entity, TouchEventArgs args) {
            ...
            _hostPrim.Say("Added " + TimeInc + " to wait to make " + _control.Wait);
        }
    }
}
