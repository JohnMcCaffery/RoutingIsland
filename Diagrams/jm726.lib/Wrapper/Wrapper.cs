...
namespace jm726.lib.wrapper {
    ...
    public abstract class Wrapper<TToWrap> : Wrapper, IWrapper<TToWrap> where TToWrap : class {
        ...
        public Wrapper(TToWrap instance, string nameSuffix = null, bool recursive = true, bool listen = false) {
            if (instance == null)
            ...
            _name = WrappedInterface.FullName + "_" + _instanceType.FullName  + "_" + (nameSuffix == null ? "Wrapper" : nameSuffix) + (recursive ? "R" : "");
            _listen = listen;
